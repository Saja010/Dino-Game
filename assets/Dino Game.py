...
class score:
    ...
    def show (self):
        ...
        lbl_width=self.lbl.get_rect().width   # to get the width of the text 
        screen.blit(self.lbl,(WIDTH-lbl_width-10,10))  # to fit the text on the screen when the width is increesing 
...
class Game:
    ...
    def restart(self):
        self.__init__(hs=self.score.hs)  # to put all the vauls in the defult 
